...
xv_cxl_lib_path="/media/alex/Elements/xilinx/Vivado/2021.1/data/xsim"
xv_cpt_lib_path="/media/alex/Elements/xilinx/Vivado/2021.1/data/simmodels/xsim/2021.1/lnx64/6.2.0/systemc/protected"
xv_ext_lib_path="/media/alex/Elements/xilinx/Vivado/2021.1/data/simmodels/xsim/2021.1/lnx64/6.2.0/ext"
...
xv_ref_path=${VIVADO_LOC:-"/media/alex/Elements/xilinx/Vivado/2021.1"}
...
compile()
{
  ...
  xsc -c $xsc_opts --gcc_compile_options "-DBOOST_SYSTEM_NO_DEPRECATED" --gcc_compile_options "-I../../../../kv260_platform.gen/sources_1/bd/system/ip/system_zynq_ultra_ps_e_0_0/sim_tlm -I../../../bd/system/ip/system_zynq_ultra_ps_e_0_0/sim -I$xv_boost_lib_path -I$xv_cxl_lib_path/ip/xtlm/include -I$xv_cxl_lib_path/ip/remote_port_sc_v4/include -I$xv_cxl_lib_path/ip/remote_port_c_v4/include -I$xv_cxl_lib_path/ip/common_cpp_v1_0/include" -work xil_defaultlib -f xsc.prj 2>&1 | tee compile.log
}

# RUN_STEP: <elaborate>
elaborate()
{
  xsc --shared -lib xil_defaultlib -lib zynq_ultra_ps_e_v3_3_5 -gcc_link_options "-L$xv_cxl_lib_path/ip/xtlm -lxtlm" -gcc_link_options "-L$xv_cxl_lib_path/ip/remote_port_sc_v4 -lremote_port_sc_v4" -gcc_link_options "-L$xv_cxl_lib_path/ip/remote_port_c_v4 -lremote_port_c_v4" -gcc_link_options "-L$xv_cxl_lib_path/ip/common_cpp_v1_0 -lcommon_cpp_v1_0" -o libdpi.so
  xelab --incr --debug typical --relax --mt auto -sv_root "$xv_cxl_lib_path/ip/xtlm" -sc_lib libxtlm.so --include "$xv_cxl_lib_path/ip/xtlm/include" -sv_root "$xv_cxl_lib_path/ip/remote_port_sc_v4" -sc_lib libremote_port_sc_v4.so --include "$xv_cxl_lib_path/ip/remote_port_sc_v4/include" -sv_root "$xv_cxl_lib_path/ip/remote_port_c_v4" -sc_lib libremote_port_c_v4.so --include "$xv_cxl_lib_path/ip/remote_port_c_v4/include" -sv_root "$xv_cxl_lib_path/ip/common_cpp_v1_0" -sc_lib libcommon_cpp_v1_0.so --include "$xv_cxl_lib_path/ip/common_cpp_v1_0/include" --include "../../../../kv260_platform.gen/sources_1/bd/system/ip/system_zynq_ultra_ps_e_0_0/sim_tlm" --include "../../../bd/system/ip/system_zynq_ultra_ps_e_0_0/sim" --include "$xv_boost_lib_path" -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_13 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_15 -L generic_baseblocks_v2_1_0 -L fifo_generator_v13_2_5 -L axi_data_fifo_v2_1_23 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_24 -L axi_protocol_converter_v2_1_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm -sv_root "." -sc_lib libdpi.so --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/media/alex/Elements/xilinx/Vivado/2021.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
